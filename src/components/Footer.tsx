  ...
  return (
    <div className="flex flex-col md:flex-row lg:justify-between px-12 bg-[#f8fafc] py-10 gap-10">
        ...
        <div className="flex flex-col gap-5">
            <div>
                <img src="https://bixilife.com/_app/immutable/assets/biti%20logo.DMhA3Suo.png" alt="" className="w-24 h-10" />
            </div>
        ...
        <div className="flex flex-col gap-5 lg:w-1/4">
            ...
            <h1>Discover all things comfort & be the first to hear about exciting new products!</h1>
            <div className="p-2 bg-white rounded-full border flex items-center justify-center" >
                <input type="text" placeholder="Enter Your Email" className="p-2 w-full outline-none"/>
